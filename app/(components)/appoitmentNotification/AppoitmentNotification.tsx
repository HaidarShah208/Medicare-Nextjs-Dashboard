"use client";
import { AppointmentDataType } from "@/app/constant/allTypes/AllTypes";
...
export default function ToastNotification() {
  const appointments: AppointmentDataType[] = useSelector(
    (s: RootState) => s.getAppointments.appointments
  );
    ...
    const checkAppointmentTime = () => {
      ...
      appointments.forEach((appointment) => {
        ...
        if (
          ...
          showToast(
            `Your appointment with ${appointment.patientsName} is in ${minutesDifference} minutes.`
          );
        }
      });
    };
